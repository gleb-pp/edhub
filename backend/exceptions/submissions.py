...
class SubmissionNotFoundError(SubmissionError):
    ...
    def __init__(self, course_id: str, assignment_id: int, student_email: str) -> None:
        super().__init__(f"Submission of student {student_email} to the assignment {assignment_id} does not exist in the course {course_id}.")
...
class SubmissionGradedError(SubmissionError):
    ...
    def __init__(self, course_id: str, assignment_id: int, student_email: str) -> None:
        super().__init__(f"Submission of student {student_email} to the assignment {assignment_id} withing the course {course_id} is already graded.")
...
class GradeNotFoundError(SubmissionError):
    ...
    def __init__(self, course_id: str, assignment_id: int, student_email: str) -> None:
        super().__init__(f"Submission of student {student_email} to the assignment {assignment_id} withing the course {course_id} is not graded.")
