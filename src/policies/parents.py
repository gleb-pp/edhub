...
class ParentPolicy:
    ...
    def assert_parent_access(parent: User, course: Course, db: Session) -> None:
        """Assert that the provided user has a parent role in the provided course."""
    ...
    def assert_not_parent(user: User, course: Course, db: Session) -> None:
        """Assert that the provided user is already a parent in the provided course."""
    ...
    def assert_not_parent_of_student(
        ...
        """Assert that the provided user is not a parent of the student in the provided course."""
    ...
    def assert_parent_of_student(
        ...
        """Assert that the provided user is already parent of the student in the provided course."""
    ...
    def assert_access_to_parent(
        ...
        """Assert that the provided user has access to the provided parent."""
