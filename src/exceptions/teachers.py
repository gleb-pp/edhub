...
class InstructorRoleRequiredError(TeacherError):
...
class TeacherRoleRequiredError(TeacherError):
...
class TeacherRoleConflictError(TeacherError, RoleConflictError):
